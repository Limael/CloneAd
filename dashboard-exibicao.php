...
<body>
    ...
    <div class="dashboard-header">
        <div class="div-flex-header border-bottom border-top">
            <div class="flex-left">
                <span class="pgInicial-text">Página inicial: Exibição</span>
            ...
            <div class="card card-generic">
                <div class="card-body pb-5">
                    <div class="top-header d-flex align-items-start">
                        <h5 class="card-title me-1">Inventário para revisão</h5>
                        <img src="./images/question-circle.svg" alt="">
                    </div>
                    <div class="revisao-badges">
                    <span class="badge rounded-pill text-bg-primary pb-1">Recomendado (0)</span>
                    <a href="#">Saiba mais sobre filtros</a>
                    </div>
                    <div class="card-content mt-5 mb-3 text-center d-flex align-items-center">
                        <p class="card-text">Nenhum dos seus inventários precisa de atenção.</p>
                    </div>
                </div>
            </div>
        </div>
