...
<head>
    ...
    <title>Dashboard-Velocidade</title>
</head>
...
<body>
    ...
    <div class="dashboard-header">
        <div class="div-flex-header border-bottom border-top">
            <div class="flex-left">
                <span class="pgInicial-text">Página inicial: Velocidades dos anúncios</span>
                ...
                <div class="card-body pb-5">
                    <div class="top-header d-flex align-items-start justify-content-between">
                        <div class="d-flex align-items-start">
                            <h5 class="card-title me-1 title-indica">Visão geral da velocidade dos anúncios</h5>
                        </div>
                        <select class="form-select" style="width: 30%;" aria-label="Default select example">
                            <option selected>Todo o inventário disponível</option>
                        </select>
                    </div>
                    <div class="revisao-badges">
                        <span href="#">4 de dez. - 2 de jan.</span>
                    </div>
                    <div class="d-flex">
                        <div class="border d-flex flex-column" style="font-size: 12px;width:33.33%;">
                            <span style="width:54%;">Tempo entre a navegação na página e o carregamento da tag <img src="./images/question-circle.svg" alt=""></span>
                            <span>Não há dados suficientes para medir a nota</span>
                        </div>
                        <div class="border d-flex flex-column" style="font-size: 12px;width:33.33%;">
                            <span>Tempo entre a navegação na página e o carregamento da tag <img src="./images/question-circle.svg" alt=""></span>
                            <span>Não há dados suficientes para medir a nota</span>
                        </div>
                        <div class="border d-flex flex-column" style="font-size: 12px;width:33.33%;">
                            <span>Tempo entre a navegação na página e o carregamento da tag <img src="./images/question-circle.svg" alt=""></span>
            ...
            <div class="card card-generic">
                <div class="card-body pb-5">
                    <div class="top-header d-flex align-items-start">
                        <h5 class="card-title me-1">Tempo de carregamento do criativo por anunciante</h5>
                    </div>

                    <div class="card-content mt-5 mb-3 text-center d-flex align-items-center">
                        <p class="card-text">Não há dados disponíveis do tempo de carregamento do criativo.</p>
                    </div>
                </div>
            </div>
        </div>
